  ...
  <div class="app-container">
    ...
    <el-card class="tableCard" shadow="never">
      ...
      <el-form ref="form" :model="addBasicForm" label-width="100px" label-position="top" disabled>
        <el-row :gutter="20">
          <el-col :span="4">
            <el-form-item label="运维工单类型">
              <el-select v-model="type" placeholder="常规">
        ...
        <div class="userTitle" v-if="type == 1">用户信息</div>
        <el-row :gutter="10" style="margin-bottom:20px" v-if="type == 1">
          <el-col :span="4">
            <el-form-item label="业务类型">
